  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      >
        ...
        <ChevronDown
          className={`w-3.5 h-3.5 text-zinc-400 group-hover:text-zinc-600 dark:group-hover:text-zinc-200 transition-transform duration-200 ${isOpen ? "rotate-180" : ""}`}
        />
      </button>
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-1.5 flex items-center justify-between gap-1.5">
                  <div className="flex items-center gap-1">
                    <span
                      className={`inline-block px-2 py-0.5 rounded-md font-bold text-[10px] border ${roleDetail.badgeBg} ${roleDetail.badgeBorder} ${roleDetail.badgeText}`}
                    >
                      {currentUser.role}
                    </span>
                    {isSuperAdminUser && (
