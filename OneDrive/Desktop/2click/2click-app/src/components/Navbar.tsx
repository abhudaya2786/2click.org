...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const isSuperAdminUser =
    ...
    currentUser?.email?.toLowerCase() === "shrinet.info@gmail.com";
  ...
  const handleLogoClick = () => {
    ...
    if (newCount >= 3) {
      ...
      if (
        pin === (systemSettings?.superAdminSecretPin || "2026") ||
        pin === "2CLICK-ADMIN-KEY"
      ) {
  ...
  const menuCategories = [
    {
      ...
      items: [
        {
          id: "dashboard",
          label: t("dashboard", "Executive Dashboard"),
          icon: LayoutDashboard,
          badge: t("badgeAnalytics", "Analytics"),
          desc: t(
            "dashboardDesc",
            "KPIs, Project Milestones & Live Cost Index",
          ),
          enabled: true,
        },
        {
          id: "home",
          label: t("home", "Project Hub & Overview"),
          icon: Home,
          badge: t("badgeCore", "Core"),
          desc: t("homeDesc", "Project B2B Hub, City Metrics & Quick Tools"),
          enabled: modules.home !== false,
        },
        {
          id: "construction",
          label: t(
            "construction",
            labels["construction"] || "Civil BOQ & Material Costing",
          ),
          icon: Hammer,
          badge: t("badgeAiEngine", "AI Engine"),
          desc: t(
            "constructionDesc",
            "Cement, Steel, Footing & Quantity Takeoff",
          ),
          enabled: modules.construction !== false,
        },
        {
          id: "naksha_vastu",
          label: t(
            "naksha_vastu",
            labels["naksha_vastu"] || "Naksha & Vastu Studio",
          ),
          icon: Compass,
          badge: "2D/3D",
          desc: t(
            "naksha_vastuDesc",
            "House Layouts, Vastu Compass & Architect Chat",
          ),
          enabled: modules.naksha_vastu !== false,
        },
        {
          id: "interior",
          label: t("interior", "Interior Design Studio"),
          icon: Palette,
          badge: t("badgeStudio", "Studio"),
          desc: t("interiorDesc", "3D Room Layouts & Interior Specs"),
          enabled: true,
        },
      ],
    },
      ...
      items: [
        {
          ...
          label: t(
            "electrical_elv",
            labels["electrical_elv"] || "Electrical & ELV Studio",
          ),
          icon: Zap,
          badge: t("badgeMep", "MEP"),
          desc: t("electrical_elvDesc", "Transformers, Substations & Cables"),
          enabled: modules.electrical_elv !== false,
        },
        {
          id: "water_etp_stp",
          label: t(
            "water_etp_stp",
            labels["water_etp_stp"] || "Water & ETP/STP Systems",
          ),
          icon: Droplets,
          badge: t("badgePlumbing", "Plumbing"),
          desc: t(
            "water_etp_stpDesc",
            "Effluent & Sewage Treatment Plant Design",
          ),
          enabled: modules.water_etp_stp !== false,
        },
        {
          id: "tiles_marble",
          label: t(
            "tiles_marble",
            labels["tiles_marble"] || "Tiles & Marble Studio",
          ),
          icon: Grid,
          badge: t("badgeFlooring", "Flooring"),
          desc: t(
            "tiles_marbleDesc",
            "Tile Box Calculator, Usama & Labor Rates",
          ),
          enabled: true,
        },
        {
          id: "solar",
          label: t("solar", labels["solar"] || "Solar Rooftop & Subsidies"),
          icon: Sun,
          badge: t("badgeMnre", "MNRE"),
          desc: t("solarDesc", "KW Solar Power & PM Surya Ghar Subsidy"),
          enabled: modules.solar !== false,
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "hyperlocal_directory",
          label: t("hyperlocal_directory", "📍 हाइपर-लोकल वेंडर डायरेक्टरी"),
          icon: Navigation,
          badge: t("badgeGps", "GPS Radius"),
          desc: t(
            "hyperlocalDesc",
            "GPS लोकेशन और दूरी के आधार पर पास के सप्लायर",
          ),
          enabled: true,
        },
        {
          id: "vendor_enrolment",
          label: t("vendor_enrolment", "🏪 वेंडर एनरोलमेंट फ़ॉर्म"),
          icon: Store,
          badge: t("badgeJoin", "Register"),
          desc: t(
            "vendorEnrolmentDesc",
            "दुकान पंजीकृत करें और GPS लोकेशन टैग करें",
          ),
          enabled: true,
        },
        {
          id: "bidding_hub",
          label: t("bidding_hub", "⚖️ Master Bidding & Tender Suite"),
          icon: Gavel,
          badge: "Cyber Suite",
          desc: "Bidding Dashboard, Tender Registry, Comparative L1 Matrix & Rule Engine",
          enabled: true,
        },
        {
          id: "vendors_binding",
          label: t(
            "vendors_binding",
            labels["vendors_binding"] || "Vendor Binding & Tenders",
          ),
          icon: Gavel,
          badge: t("badgeB2bBidding", "B2B Bidding"),
          desc: t(
            "vendors_bindingDesc",
            "Contractor Directory, Escrow & Tenders",
          ),
          enabled: modules.vendors_binding !== false,
        },
        {
          id: "dukandar_market",
          label: t(
            "dukandar_market",
            labels["dukandar_market"] ||
              "🛒 2click Mart (Flipkart & Amazon B2B)",
          ),
          icon: Store,
          badge: t("badgeMarket", "E-Com Mart"),
          desc: t(
            "dukandar_marketDesc",
            "Flipkart & Amazon Style Building Materials & Hardware Mart",
          ),
          enabled: modules.dukandar_market !== false,
        },
        {
          id: "logistics",
          label: t(
            "logistics",
            labels["logistics"] || "Freight & Logistics Hub",
          ),
          icon: Truck,
          badge: t("badgeFleet", "Fleet"),
          desc: t("logisticsDesc", "Tipper Trucks, Cement Dispatch & GPS"),
          enabled: true,
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "ca_gst",
          label: t("ca_gst", labels["ca_gst"] || "CA Services & GST Hub"),
          icon: FileCheck,
          badge: t("badgeTaxItr", "Tax & ITR"),
          desc: t("ca_gstDesc", "GST Filing, TDS Returns, ITR & Audit"),
          enabled: true,
        },
        {
          id: "crm_khatabook",
          label: t(
            "crm_khatabook",
            labels["crm_khatabook"] || "KhataBook & CRM ERP Suite",
          ),
          icon: BookOpen,
          badge: t("badgeErp", "ERP"),
          desc: t(
            "crm_khatabookDesc",
            "Ledger Book, UDHAR Management & Invoicing",
          ),
          enabled: true,
        },
        {
          ...
          label: t(
            "bank_loans",
            labels["bank_loans"] || "Bank Loans & Escrow KYC",
          ),
          icon: Landmark,
          badge: t("badgeBanking", "Banking"),
          desc: t("bank_loansDesc", "Project Sanctions, Escrow Finance & KYC"),
          enabled: modules.bank_loans !== false,
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "lidar",
          label: t("lidar", labels["lidar"] || "LiDAR 3D Point Cloud Survey"),
          icon: Box,
          badge: t("badgeLaser3d", "Laser 3D"),
          desc: t("lidarDesc", "Drone Topo Surveys & Spatial Measurements"),
          enabled: modules.lidar !== false,
        },
        {
          id: "vr",
          label: t("vr", labels["vr"] || "3D VR Site Walkthrough"),
          icon: Eye,
          badge: t("badgeWebxr", "WebXR"),
          desc: t("vrDesc", "Virtual Reality Construction Inspection"),
          enabled: modules.vr !== false,
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "super_admin",
          label: t("superAdmin", "Super Admin Portal"),
          icon: ShieldCheck,
          badge: t("badgeAdmin", "Admin"),
          desc: t(
            "super_adminDesc",
            "System Configuration, Role Permissions & Settings",
          ),
  ...
  const currentActiveItem =
    allMenuItems.find((item) => item.id === activeTab) || allMenuItems[0];

  // Mock Procore Notifications Data
  const mockNotifications = [
    {
      id: "1",
      title: "Steel Price Index Alert",
      desc: "Fe 550D TMT Steel rate updated in Bengaluru zone (+₹850/tonne)",
      time: "10 mins ago",
      unread: true,
    },
    {
      ...
      desc: "Q2 GSTR-3B compliance submission window is active",
      time: "1 hour ago",
      unread: true,
    },
    {
      ...
      desc: "Apex Structural Infra submitted tender for BOQ #2026-B",
      time: "3 hours ago",
      unread: false,
    },
    {
      ...
      desc: "₹78,000 Government Subsidy credited for 3KW solar install",
      time: "1 day ago",
      unread: false,
    },
  ];
  ...
  const activeCategoryWl = systemSettings?.categoryWhiteLabels?.find(
    (c) =>
      ...
      (c.id === systemSettings.activeGlobalWhiteLabelId ||
        c.categoryKey === activeTab),
  );
    ...
    <div className="min-h-screen flex flex-col bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans transition-colors">
      ...
      <header className="h-16 bg-slate-900 border-b border-slate-800 text-white flex items-center justify-between px-3 sm:px-5 sticky top-0 z-40 shadow-sm shrink-0">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          >
            {isSidebarCollapsed ? (
              <PanelLeftOpen className="w-5 h-5 text-orange-400" />
            ) : (
          ...
          >
            {activeCategoryWl ? (
              ...
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-orange-500 via-orange-600 to-amber-600 flex items-center justify-center text-white shadow-md shadow-orange-500/20 group-hover:scale-105 transition-transform border border-white/20 shrink-0">
            ...
            <div className="flex flex-col text-left max-w-[180px] sm:max-w-xs">
              <div className="flex items-center gap-1.5 truncate">
                <span className="font-black text-base sm:text-lg tracking-tight text-white leading-none truncate">
                  {activeCategoryWl
                    ? activeCategoryWl.partnerBrandName
                    : systemSettings?.siteName || "2Click"}
                </span>
                <span
                  className={`text-[8px] sm:text-[9px] font-black uppercase px-1.5 py-0.5 rounded-xs border tracking-wider shrink-0 ${
                    activeCategoryWl
                      ? "bg-emerald-500/20 text-emerald-300 border-emerald-500/40"
                      : "bg-orange-500/20 text-orange-400 border-orange-500/40"
                  }`}
                >
                  {activeCategoryWl ? "WHITE-LABEL" : "PROCORE OS"}
                </span>
              </div>
              <span className="text-[10px] font-extrabold text-slate-400 tracking-wider uppercase leading-tight truncate">
                {activeCategoryWl
                  ? activeCategoryWl.customBannerTagline ||
                    activeCategoryWl.categoryDisplayName
                  : systemSettings?.siteTagline ||
                    "Enterprise Construction B2B"}
              </span>
            </div>
          </button>
                ...
                <button
                  onClick={async () => {
                    ...
                    if (loc.district) {
                      ...
                      alert(
                        `📍 Procore Free Location API: Auto-detected district "${loc.district}, ${loc.state}"`,
                      );
                    }
                  }}
          ...
          {globalSearchFocused && globalSearch.trim().length > 0 && (
            ...
            >
              <div className="text-[10px] font-extrabold uppercase text-slate-400 px-3 py-1 tracking-wider flex items-center justify-between">
                <span>
                  Matching Procore Modules ({filteredSearchItems.length})
                </span>
              ...
              {filteredSearchItems.length > 0 ? (
                ...
                <div className="p-4 text-center text-xs text-slate-400">
                  No matching Procore tools found for "{globalSearch}". Try
                  "BOQ", "GST", "Solar", "Naksha", or "Logistics".
                </div>
              )}
            </div>
          )}
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          <div className="relative">
            ...
            >
              ...
              <ChevronDown
                className={`w-3 h-3 text-slate-400 transition-transform ${langDropdownOpen ? "rotate-180" : ""}`}
              />
            </button>
          ...
          {systemSettings?.publicDisplayControls?.showAiCopilotButton !==
            false && (
            <button
          ...
          <div className="flex-1 overflow-y-auto no-scrollbar p-2 space-y-4">
            {menuCategories.map((cat, idx) => {
              ...
              const filteredItems = cat.items.filter(
                (item) =>
                  item.enabled &&
                  (!sidebarSearchFilter.trim() ||
                    item.label
                      .toLowerCase()
                      .includes(sidebarSearchFilter.toLowerCase())),
              );
                      ...
                      >
                        ...
                        {!isSidebarCollapsed && (
                          <div className="flex-1 min-w-0 flex items-center justify-between">
                            ...
                            {item.badge && (
                              <span
                                className={`text-[9px] font-extrabold px-1.5 py-0.2 rounded-xs uppercase tracking-tight shrink-0 ${
                                  isActive
            ...
            <div className="flex items-center gap-2">
              {currentUser && (
                <div className="relative inline-block text-left">
                  <div
                    className={`flex items-center gap-1.5 px-2.5 py-1 rounded-lg border text-xs font-bold transition-all shadow-2xs ${userRoleDetail.badgeBg} ${userRoleDetail.badgeBorder} ${userRoleDetail.badgeText}`}
                  >
                    <ShieldCheck className="w-3.5 h-3.5 shrink-0 text-emerald-500" />
                    <span>
                      Logged in as:{" "}
                      <strong className="underline underline-offset-2 decoration-emerald-500/40">
                        {currentUser.role}
                      </strong>
                    </span>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl z-50 p-4 animate-in fade-in zoom-in-95 duration-150 text-slate-900 dark:text-slate-100 space-y-3">
                      <div className="flex items-start justify-between border-b border-slate-100 dark:border-slate-800 pb-2.5">
                        <div className="space-y-0.5">
                          <span
                            className={`inline-block px-2 py-0.5 rounded-md text-[10px] font-black uppercase tracking-wider ${userRoleDetail.badgePill}`}
                          >
                      ...
                      <div className="space-y-1.5 pt-1">
                        ...
                        <ul className="space-y-1 text-[11px]">
                          {userRoleDetail.keyPermissions.map((perm, idx) => (
                            <li
                              key={idx}
                              className="flex items-start gap-1.5 text-slate-700 dark:text-slate-200 font-medium"
                            >
