...
export const VendorEnrolmentForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const existing = getSafeLocalStorage<VendorEnrolmentData[]>(
      "2click_registered_vendors",
      [],
    );
    ...
    <div className="max-w-2xl mx-auto p-6 bg-slate-900 border border-slate-800 rounded-2xl text-slate-100 shadow-2xl space-y-5">
      <div className="border-b border-slate-800 pb-3">
        ...
        <p className="text-xs text-slate-400">
          अपनी दुकान का प्रकार सेट करें और सटीक गूगल GPS लोकेशन दर्ज करें
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-xs">
        ...
        <div>
          <div className="flex justify-between items-center mb-1">
            ...
            >
              <Edit3 size={12} />{" "}
              {isCustomShopType ? "ड्रॉपडाउन चुनें" : "कस्टम प्रकार लिखें"}
            </button>
          </div>
          ...
          {!isCustomShopType ? (
            <select
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-white focus:outline-none focus:border-emerald-500"
            >
              <option value="सोलर रूफटॉप एवं इनवर्टर हब">
                ☀️ सोलर रूफटॉप एवं इनवर्टर हब
              </option>
              <option value="टाइल्स, मार्बल एवं सैनिटरी स्टोर">
                🧱 टाइल्स, मार्बल एवं सैनिटरी स्टोर
              </option>
              <option value="लॉजिस्टिक्स एवं गाड़ी भाड़ा (Freight Vehicles)">
                🚚 लॉजिस्टिक्स एवं गाड़ी भाड़ा (Freight Vehicles)
              </option>
              <option value="हार्डवेयर, सीमेंट एवं सरिया सप्लायर">
                🏗️ हार्डवेयर, सीमेंट एवं सरिया सप्लायर
              </option>
              <option value="आर्किटेक्ट, नक्शा व सिविल कॉन्ट्रैक्टर">
                📐 आर्किटेक्ट, नक्शा व सिविल कॉन्ट्रैक्टर
              </option>
              <option value="इलेक्ट्रिकल एवं वायरिंग स्टोर">
                ⚡ इलेक्ट्रिकल एवं वायरिंग स्टोर
              </option>
            </select>
          ) : (
            <input
        ...
        <div className="bg-slate-950 border border-slate-800 p-4 rounded-xl space-y-3">
          <div className="flex justify-between items-center">
            <span className="font-semibold text-slate-300 flex items-center gap-1.5">
              <MapPin size={16} className="text-amber-400" /> दुकान की गूगल GPS
              लोकेशन:
            </span>
            <button
              type="button"
          ...
          <div className="text-[11px] text-slate-400 grid grid-cols-2 gap-2 bg-slate-900 p-2 rounded-lg">
            <div>
              Lat:{" "}
              <span className="text-white font-mono">{formData.latitude}</span>
            </div>
            <div>
              Lng:{" "}
              <span className="text-white font-mono">{formData.longitude}</span>
            </div>
          </div>
          ...
          {formData.googleMapUrl && (
            ...
            >
              <ExternalLink size={12} /> गूगल मैप्स पर अपनी दुकान की लोकेशन
              देखें
            </a>
          )}
        </div>
