...
export const VendorShareLinkCard: React.FC<VendorDashboardProps> = ({
  vendor,
}) => {
  ...
  return (
    <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4 space-y-3">
      ...
      <p className="text-[11px] text-slate-400">
        Share this link on WhatsApp or social media. Customers visiting through
        this link will see{" "}
        <span className="text-slate-200 font-semibold">
          only your branding, your rates, and your helpline number
        </span>
        .
      </p>
