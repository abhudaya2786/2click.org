...
export const THEME_PRESETS: ThemePreset[] = [
  {
    ...
    description:
      "Sleek Tailstore dark sticky header (#0f172a), high-contrast white text, rounded pill controls, and crisp emerald accents.",
  ...
  },
  {
    ...
    description:
      "Deep midnight obsidian canvas with subtle metallic highlights for luxury real estate & AI infrastructure.",
  ...
  },
  {
    ...
    description:
      "Deep sapphire ocean blue with electric cyan highlights for bank loan & escrow finance.",
  ...
  },
  {
    ...
    badgeBg: "bg-emerald-500/20 text-emerald-300 border-emerald-400/30",
    description:
      "Crisp structural emerald green and concrete steel slate for building materials & contractors.",
  ...
  },
  {
    ...
    description:
      "Glowing solar amber and warm gold tones designed for rooftop solar & electrical MEP.",
  ...
  },
  {
    ...
    description:
      "Electric violet neon and futuristic deep purple canvas for 3D LiDAR point clouds & AI Copilot.",
  ...
  },
  {
    ...
    description:
      "Clean pearl white snow with sharp royal indigo typography for modern corporate B2B.",
      ...
      <div className="bg-white dark:bg-slate-900 w-full max-w-4xl max-h-[85vh] overflow-y-auto no-scrollbar rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl my-auto animate-in fade-in zoom-in duration-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-black text-white mt-1">
                {isHi
                  ? "भारतीय भाषाएँ, डैशबोर्ड डिज़ाइन एवं थीम विकल्प"
                  : "Languages, Dashboard Layouts & Theme Options"}
              </h2>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-6 max-h-[72vh] overflow-y-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-teal-200/60 dark:border-teal-800/60 pb-3">
              <div>
                <span className="px-2.5 py-0.5 bg-teal-600 text-white text-[10px] font-black rounded-md uppercase tracking-wider flex items-center gap-1 w-fit mb-1">
                  <Globe className="w-3.5 h-3.5" /> 22 Official Indian Languages
                  + English
                </span>
                <h3 className="text-base font-black text-slate-900 dark:text-white">
                  {isHi
                    ? "अपनी पसंदीदा भारतीय भाषा चुनें (Select Preferred Language)"
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-slate-400 font-semibold">
                {DASHBOARD_DESIGN_PRESETS.length} Dashboard Styles
              </span>
            </div>
              ...
              {DASHBOARD_DESIGN_PRESETS.map((preset) => {
                ...
                return (
                  <button
                    ...
                    onClick={() =>
                      onSelectDashboardPreset &&
                      onSelectDashboardPreset(preset.id)
                    }
          ...
          <div className="p-4 bg-slate-50 dark:bg-slate-800/80 rounded-2xl border border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="space-y-1">
              <span className="px-2.5 py-0.5 bg-indigo-100 dark:bg-indigo-950 text-indigo-800 dark:text-indigo-300 text-[10px] font-black rounded-md uppercase tracking-wider flex items-center gap-1 w-fit">
                <Sparkles className="w-3 h-3 text-indigo-500" /> Ultra-Clean
                Layout
              </span>
              <h3 className="text-sm font-black text-slate-900 dark:text-white">
                कम विकल्प एवं मॉडर्न मिनिमल लुक (Minimum Options &amp;
                Ultra-Modern Layout)
              </h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">
                नेविगेशन बार को केवल 4 मुख्य बटन (Home, Engineering Tools,
                KhataBook, AI) में संक्षिप्त करें।
              </p>
            </div>
            ...
            >
              ...
              <span>
                {minimalistMode ? "Minimal Mode: ON" : "Minimal Mode: OFF"}
              </span>
            </button>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-slate-400 font-semibold">
                {THEME_PRESETS.length} Available Themes
              </span>
            </div>
              ...
              {THEME_PRESETS.map((preset) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      <span
                        className={`px-2 py-0.5 rounded-md text-[10px] font-black uppercase border ${preset.badgeBg}`}
                      >
                        {preset.category}
                      </span>
        ...
        <div className="p-4 bg-slate-100 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-slate-500">
          <span className="font-bold">
            💡 चुने गए भाषा, थीम और डैशबोर्ड लेआउट से पूरा ऐप तुरंत लाइव अपडेट
            होगा।
          </span>
          <button
            onClick={onClose}
