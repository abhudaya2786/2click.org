          ...
          <div className="relative group max-w-4xl max-h-[70vh] rounded-3xl overflow-hidden border-2 border-teal-500/50 shadow-2xl bg-slate-900">
            ...
            <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-slate-950 via-slate-950/80 to-transparent p-6 text-white space-y-2">
              ...
              <p className="text-xs text-slate-300">
                Double-clicked 3D High-Resolution inspection mode. Scroll or use
                controls to zoom into details.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-slate-700/60">
          ...
          <button
            ...
            className="p-2 text-rose-500 hover:text-white bg-rose-50 hover:bg-rose-600 dark:bg-rose-950/40 dark:hover:bg-rose-600 border border-rose-200 dark:border-rose-800/60 rounded-xl transition flex items-center gap-1.5 text-xs font-bold active:scale-95"
