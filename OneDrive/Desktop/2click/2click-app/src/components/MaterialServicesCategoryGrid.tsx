...
export const PRESET_MATERIAL_PHOTOS = [
  ...
  {
    name: "Lithium Battery Wall",
    url: "https://images.unsplash.com/photo-1558441719-6705166e2106?auto=format&fit=crop&w=600&q=80",
  },
  {
    name: "Electric Wire Coil",
  ...
  {
    name: "LED Bulb / Lights",
    url: "https://images.unsplash.com/photo-1550985616-10810253b84d?auto=format&fit=crop&w=600&q=80",
  },
  {
    name: "Cement Bag",
  ...
  {
    name: "Red Kiln Bricks",
    url: "https://images.unsplash.com/photo-1584467735815-f778f274e296?auto=format&fit=crop&w=600&q=80",
  },
  {
    name: "Paint Bucket / Wall",
    url: "https://images.unsplash.com/photo-1562259949-e8e7689d7828?auto=format&fit=crop&w=600&q=80",
  },
  {
    name: "Plumbing Pipes",
  ...
  {
    name: "Hardware Locks & Handles",
    url: "https://images.unsplash.com/photo-1585336261026-8f5786392b66?auto=format&fit=crop&w=600&q=80",
  },
  {
    name: "Power Drill & Tools",
    url: "https://images.unsplash.com/photo-1504148455328-c376907d081c?auto=format&fit=crop&w=600&q=80",
  },
  {
    name: "Plywood Board & Sheet",
    url: "https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=600&q=80",
  },
  {
    name: "Glass Window & Aluminium",
        ...
        items: [
          {
            ...
            specs:
              "21.5% Efficiency, 25-Year Performance Warranty, Heavy GI Mounting Board Structure Included",
            rateINR: 15800,
            ...
            description:
              "Top grade Mono PERC half-cut solar panel mounted on heavy galvanized iron roof board structure for extreme wind resistance.",
            inStock: true,
          },
          {
            id: "sol-02",
            ...
            brand: "Tata Power",
            specs:
              "Includes 3KW Panels, Net Metering Box, DC Wiring Board, Galvanized Frame",
            rateINR: 145000,
            ...
            description:
              "Turnkey 3KW solar rooftop system with official net metering application and state DISCOM approval.",
            inStock: true,
          },
          {
            id: "sol-03",
            ...
            brand: "Adani Solar",
            specs:
              "Dual Sided Generation (+30% Rear Power Boost), Ultra Glass Board Protection",
            rateINR: 17200,
            unit: "Per Panel",
            imageUrl:
            ...
            tag: "Dual Glass Tech",
            description:
              "Bifacial solar glass board module capturing sunlight from both front and ground reflection.",
            inStock: true,
          },
          {
            id: "sol-04",
            ...
            specs:
              "Rust-proof Hot Dip Galvanized Iron, 30 Degree Tilt Angle Board, Wind Speed 150 kmph",
            rateINR: 4200,
            ...
            description:
              "Heavy gauge solar roof frame structure board for secure solar panel elevated mounting.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            brand: "Luminous",
            specs:
              "1500VA / 12V-24V Hybrid MPPT Solar Inverter with LCD Monitoring Screen",
            rateINR: 11400,
            unit: "Piece",
            imageUrl:
            ...
            tag: "Pure Sine Wave",
            description:
              "High efficiency solar hybrid inverter with intelligent load battery charge controller.",
            inStock: true,
          },
          {
            id: "bat-02",
            ...
            brand: "Exide Solar",
            specs:
              "12V 150Ah C10 Rating, 5-Year Replacement Warranty, Low Maintenance",
            rateINR: 14200,
            unit: "Piece",
            imageUrl:
            ...
            tag: "5-Year Warranty",
            description:
              "Specialized deep cycle C10 tubular solar battery for high thermal stability in Indian climate.",
            inStock: true,
          },
          {
            id: "bat-03",
            ...
            specs:
              "4.8kWh LiFePO4 Battery Wall Unit, 10-Year Lifecycle, Smart BMS Interface",
            rateINR: 98000,
            unit: "Piece",
            imageUrl:
              "https://images.unsplash.com/photo-1558441719-6705166e2106?auto=format&fit=crop&w=600&q=80",
            tag: "Next-Gen LiFePO4",
            description:
              "Space-saving wall mounted lithium solar battery with 6000+ deep discharge cycles.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            specs:
              "Tinned Copper Conductor, Double Insulated XLPO, Rated 1500V DC",
            rateINR: 4800,
            unit: "100m Pair Coil",
            imageUrl:
            ...
            tag: "1500V DC Rated",
            description:
              "Heavy weather resistant tinned copper DC cable for connecting solar panels to solar inverter.",
            inStock: true,
          },
          {
            id: "solwire-02",
            ...
            specs:
              "IP65 Waterproof Enclosure, 1000V Surge Protection Device (SPD), DC MCB Board",
            rateINR: 2850,
            unit: "Piece Board",
            imageUrl:
            ...
            tag: "IP65 Waterproof",
            description:
              "DC safety junction distribution board protecting solar inverter from lightning surges.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            specs:
              "100 Meter Coil, 99.97% Pure Electrolytic Copper, Flame Retardant Low Smoke",
            rateINR: 1850,
            unit: "100m Coil",
            imageUrl:
              "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?auto=format&fit=crop&w=600&q=80",
            tag: "Bestseller Wire",
            description:
              "Industry standard house wiring copper cable engineered for heat resistance and safety.",
            inStock: true,
          },
          {
            id: "wir-02",
            ...
            brand: "Polycab",
            specs:
              "100 Meter Box, High Current Capacity for Power Sockets & AC Points",
            rateINR: 2750,
            unit: "100m Coil",
            imageUrl:
              "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=600&q=80",
            ...
            description:
              "High conductivity copper cable ideal for geysers, air conditioners, and kitchen appliances.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            specs:
              "Includes 4 Switches (6A), 2 Sockets (6/16A), 1 Fan Regulator, High Grade Polycarbonate Plate",
            rateINR: 980,
            unit: "Complete Board",
            imageUrl:
              "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=600&q=80",
            tag: "Spark Shield",
            description:
              "Sleek modular switchboard plate with silver contact switches for long spark-free life.",
            inStock: true,
          },
          {
            id: "swi-02",
            ...
            brand: "Havells",
            specs:
              "Wi-Fi Enabled Smart Board, Works with Alexa/Google Assistant, Glass Touch Finish",
            rateINR: 4200,
            unit: "Board Unit",
            imageUrl:
              "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=600&q=80",
            ...
            description:
              "Tempered glass smart touch board for controlling room lights and fans via mobile app or voice.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            specs:
              "1050 Lumens, B22 Base, Surge Protection 4kV, 2-Year Replacement Guarantee",
            rateINR: 890,
            ...
            tag: "EyeComfort Tech",
            description:
              "Energy-saving cool white LED light bulbs with uniform glare-free light distribution.",
            inStock: true,
          },
          {
            id: "bul-02",
            ...
            brand: "Havells",
            specs:
              "Die-cast Aluminum Body, Warm White 3000K, Ceiling Recessed Fitting",
            rateINR: 480,
            unit: "Piece",
            imageUrl:
            ...
            description:
              "Modern ceiling spotlight for False Ceiling living room and showroom accent lighting.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            specs:
              "Portland Pozzolana Cement, Weather Shield Waterproofing Formula, IS 1489 Compliant",
            rateINR: 385,
            unit: "50kg Bag",
            imageUrl:
            ...
            description:
              "Engineered micro-fine cement for high strength slab casting, pillars, and plasters.",
            inStock: true,
          },
          {
            id: "cem-02",
            ...
            brand: "ACC Cement",
            specs:
              "Early High Strength 53 Grade, Water Repellent Coating Micro-particles",
            rateINR: 410,
            unit: "50kg Bag",
            imageUrl:
            ...
            tag: "Fast Setting",
            description:
              "Premium OPC cement designed for heavy structural columns and bridge foundations.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            brand: "Tata Steel",
            specs:
              "Earthquake Resistant Fe550D Ribbed Design, Corrosion Resistance Index 1.8",
            rateINR: 62500,
            unit: "Per Ton",
            imageUrl:
            ...
            description:
              "Primary steel TMT bars offering maximum flexibility and bonding strength with concrete.",
            inStock: true,
          },
          {
            id: "ste-02",
            ...
            brand: "JSW Steel",
            specs:
              "100% Virgin Iron Ore Grade, Uniform Rib Pattern for Superior Grip",
            rateINR: 60800,
            unit: "Per Ton",
            imageUrl:
            ...
            tag: "Best Rate Steel",
            description:
              "High tensile TMT bars manufactured from virgin blast furnace iron.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            specs:
              'Dimensions 9"x4.25"x2.75", Water Absorption <12%, Compressive Strength 105 kg/cm²',
            rateINR: 8,
            unit: "Per Piece",
            imageUrl:
            ...
            description:
              "Traditional solid burned red clay bricks for durable load-bearing exterior walls.",
            inStock: true,
          },
          {
            id: "bri-02",
            ...
            brand: "Magicrete",
            specs:
              "Thermal Insulation, Fire Resistant 4 Hours, 3x Faster Construction Speed",
            rateINR: 62,
            unit: "Per Block",
            imageUrl:
            ...
            description:
              "Eco-friendly lightweight building block reducing structural dead weight and electricity bills.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            brand: "Asian Paints",
            specs:
              "Teflon Surface Protector, Soft Sheen Finish, Washable Stain Resistance",
            rateINR: 8400,
            unit: "20L Bucket",
            imageUrl:
            ...
            tag: "Royale Luxury",
            description:
              "Ultra-durable interior wall paint with dirt resistance and smooth silk finish.",
            inStock: true,
          },
          {
            id: "pnt-02",
            ...
            brand: "Asian Paints",
            specs:
              "7-Year Performance Warranty, Silicon Additives for Anti-Algae & UV Protection",
            rateINR: 6850,
            unit: "20L Bucket",
            imageUrl:
              "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?auto=format&fit=crop&w=600&q=80",
            ...
            description:
              "Advanced exterior wall emulsion engineered for heavy rain and harsh summer heat.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            brand: "Birla White",
            specs:
              "Extra White Polymer Modified Putty, Prevents Paint Flaking, Smooth Base",
            rateINR: 890,
            unit: "40kg Bag",
            imageUrl:
              "https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=600&q=80",
            ...
            description:
              "White cement based smooth wall putty providing moisture seal before painting.",
            inStock: true,
          },
          {
            id: "put-02",
            ...
            specs:
              "Integral Liquid Waterproofing Compound for Concrete & Plaster Mortar",
            rateINR: 680,
            unit: "5L Can",
            imageUrl:
              "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?auto=format&fit=crop&w=600&q=80",
            tag: "Dampness Lock",
            description:
              "Liquid waterproofing compound added to cement mortar to stop dampness and efflorescence.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            brand: "Astral Pipes",
            specs:
              "Class 1 SDR 11, Temperature Resistance up to 93°C, NSF Certified Lead Free",
            rateINR: 420,
            unit: "3m Length",
            imageUrl:
            ...
            description:
              "High pressure CPVC pipe for hot & cold domestic plumbing lines.",
            inStock: true,
          },
          {
            id: "pip-02",
            ...
            specs:
              "Schedule 40 UPVC Pipe,UV Stabilized, Smooth Inner Bore for Maximum Flow",
            rateINR: 310,
            unit: "3m Length",
            imageUrl:
              "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&w=600&q=80",
            tag: "Heavy Pressure",
            description:
              "Durable UPVC pipe for main water supply and overhead tank connections.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            brand: "Sintex",
            specs:
              "4-Layer UV Protected Virgin Food Grade Plastic, Anti-Bacterial Silver Nano Tech",
            rateINR: 7600,
            unit: "1000L Unit",
            imageUrl:
              "https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=600&q=80",
            ...
            description:
              "4-layered thermal water tank keeping water cooler in summers and free from algae.",
            inStock: true,
          },
          {
            id: "tnk-02",
            ...
            brand: "Plasto",
            specs:
              "Insulated Foam Layer, Gold Finish UV Armor Outer Shell, 10-Year Warranty",
            rateINR: 4800,
            unit: "500L Unit",
            imageUrl:
              "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&w=600&q=80",
            tag: "Foam Insulation",
            description:
              "Insulated water tank preventing water heating during extreme summer months.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            specs:
              "Includes 2D Floor Plan, Structural Column Grid, 3D Front Elevation, Vastu Direction Audit",
            rateINR: 15,
            unit: "Per Sq.Ft.",
            imageUrl:
            ...
            description:
              "Complete home map design package with municipality map sanction documents.",
            inStock: true,
          },
          {
            id: "srv-02",
            ...
            specs:
              "Detailed Bill of Quantities, Steel Reinforcement Schedule, Concrete Mix Design Audit",
            rateINR: 2500,
            ...
            description:
              "Professional structural safety audit and accurate material estimation for bank home loans.",
            inStock: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            specs:
              "Includes Excavation, Structure, Brickwork, Plaster, Tiles, Plumbing, Wiring & Paint",
            rateINR: 1650,
            ...
            description:
              "Complete turnkey home building with 100% milestone protected escrow payments.",
            inStock: true,
          },
          {
            id: "srv-04",
            ...
            specs:
              "Rooftop Framing, Cable Wiring, Earthing Pit, Lightening Arrester & DISCOM Approval",
            rateINR: 8000,
            ...
            description:
              "End-to-end solar roof mounting, cable connection, earthing pit creation, and net meter registration.",
            inStock: true,
          },
        ],
      },
...
export const MaterialServicesCategoryGrid: React.FC<
  MaterialServicesCategoryGridProps
> = ({ currentUser, onOpenAuth }) => {
  ...
  // Modals state
  const [inquiryModalItem, setInquiryModalItem] =
    useState<SubMaterialItem | null>(null);
  ...
  const [newItemShopCategory, setNewItemShopCategory] = useState<string>(
    "बिल्डिंग व हार्डवेयर स्टोर",
  );
  const [newItemSupplierRole, setNewItemSupplierRole] = useState<string>(
    "ऑथोराइज्ड वेंडर सप्लायर",
  );
  const [newItemPhotoUrl, setNewItemPhotoUrl] = useState<string>(
    "https://images.unsplash.com/photo-1508873696983-2df515122519?auto=format&fit=crop&w=600&q=80",
  );
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "IS_CODE_MATERIAL_SERVICES_CATALOG",
  ...
  const handleConfirmOrderSubmit = (e: React.FormEvent) => {
    ...
    setSuccessToast(
      `Inquiry & Bid Request for ${inquiryModalItem.name} (Qty: ${orderQuantity} ${inquiryModalItem.unit}) sent successfully! Estimated Total: ₹${totalVal.toLocaleString("en-IN")}`,
    );
  ...
  const handleCreateNewItemSubmit = (e: React.FormEvent) => {
    ...
    setCategories((prevCats) => {
      return prevCats.map((cat) => {
        ...
        const targetSubName =
          newItemSubName || (cat.subCategories[0]?.name ?? "General Items");
        let subFound = false;
    ...
    setSuccessToast(
      `New item "${newItemName}" added at ₹${newItemPrice.toLocaleString("en-IN")} / ${newItemUnit} successfully!`,
    );
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300 text-xs font-extrabold border border-emerald-500/40">
              ...
              <span>
                Logged in as:{" "}
                <strong>{currentUser?.role || "Verified Member"}</strong>
              </span>
            ...
            <p className="text-xs text-slate-300 max-w-2xl leading-relaxed">
              Explore solar panels, inverters, batteries, wiring, switchboards,
              cement, paint, contractor & engineering rates. Click any card to
              view detailed price estimates or add custom items!
            </p>
          </div>
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="flex flex-wrap items-center gap-1.5 text-[10px]">
                ...
                <span className="px-2 py-0.5 rounded-md bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 font-bold border border-indigo-200 dark:border-indigo-800 flex items-center gap-1">
                  ...
                  <span>
                    {cat.defaultSupplierRole || "Authorized Supplier"}
                  </span>
                </span>
              </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-5xl w-full max-h-[90vh] flex flex-col shadow-2xl overflow-hidden my-auto">
            ...
            <div className="p-5 overflow-y-auto space-y-6 grow">
              {selectedCategory.subCategories
                .filter(
                  (sub) => activeSubTab === "All" || activeSubTab === sub.name,
                )
                .map((subGroup, sIdx) => {
                  const filteredItems = subGroup.items.filter(
                    (item) =>
                      item.name
                        .toLowerCase()
                              ...
                              <div>
                                ...
                                <div className="flex flex-wrap items-center gap-1.5 pt-1 text-[9px]">
                                  ...
                                  <span className="px-2 py-0.5 rounded-md bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 font-bold border border-indigo-200 dark:border-indigo-800 flex items-center gap-1">
                                    ...
                                    <span>
                                      {item.supplierRole ||
                                        selectedCategory?.defaultSupplierRole ||
                                        "Authorized Supplier"}
                                    </span>
                                  </span>
                                </div>
            ...
            <div className="p-4 bg-slate-100 dark:bg-slate-800/80 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500 shrink-0">
              <span className="flex items-center gap-1.5 font-medium">
                ...
                <span>
                  GST Tax Invoice &amp; Direct Vendor Escrow Payment Protected
                </span>
              </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                  <div className="p-3 rounded-xl bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-200 dark:border-emerald-800 text-emerald-900 dark:text-emerald-200 flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="font-extrabold">
                        {detailModalItem.shopCategory ||
                          "Building & Hardware Depot"}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-indigo-50 dark:bg-indigo-950/50 border border-indigo-200 dark:border-indigo-800 text-indigo-900 dark:text-indigo-200 flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="font-extrabold">
                        {detailModalItem.supplierRole ||
                          "Authorized Vendor Supplier"}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-4 rounded-2xl bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/40 dark:to-teal-950/40 border border-emerald-200 dark:border-emerald-800 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-black text-emerald-600 dark:text-emerald-400">
                    Base Rate: ₹
                    {detailModalItem.rateINR.toLocaleString("en-IN")} /{" "}
                    {detailModalItem.unit}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 items-center pt-2 border-t border-emerald-200/60 dark:border-emerald-800/60">
                  <div>
                    <label className="block text-[11px] font-bold text-slate-700 dark:text-slate-300 mb-1">
                      Enter Quantity ({detailModalItem.unit}):
                    </label>
                    <input
                      type="number"
                      min={1}
                      value={calcQuantity}
                      onChange={(e) =>
                        setCalcQuantity(Math.max(1, Number(e.target.value)))
                      }
                  ...
                  <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-emerald-300 dark:border-emerald-700 space-y-1">
                    <div className="text-[10px] text-slate-500 uppercase font-semibold">
                      Total Estimated Cost (Excl. Freight)
                    </div>
                    <div className="text-lg font-black text-emerald-600 dark:text-emerald-400">
                      ₹
                      {(detailModalItem.rateINR * calcQuantity).toLocaleString(
                        "en-IN",
                      )}
                    </div>
                  </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-xl w-full p-6 shadow-2xl space-y-5 my-auto">
            ...
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3">
              <h3 className="font-extrabold text-lg text-slate-900 dark:text-white flex items-center gap-2">
                ...
                <span>
                  Add Material, Solar or Service (Add Item &amp; Price)
                </span>
              </h3>
              <button
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Per KW Installation">
                      Per KW Installation
                    </option>
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">
                  Badge Tag (e.g. 25-Yr Warranty, Govt Subsidy)
                </label>
                <input
                  type="text"
              ...
              <div className="space-y-2">
                <label className="block font-bold text-slate-700 dark:text-slate-300">
                  Choose Material Photo / Image URL
                </label>
        ...
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-md w-full p-6 shadow-2xl space-y-4 animate-in zoom-in-95 duration-150">
            ...
            <div className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700">
              <img
                src={inquiryModalItem.imageUrl}
                alt={inquiryModalItem.name}
                referrerPolicy="no-referrer"
                className="w-14 h-14 object-cover rounded-xl shrink-0"
              />
              <div>
                <div className="text-[10px] font-bold text-indigo-500 uppercase">
                  {inquiryModalItem.brand}
                </div>
                ...
                <div className="text-xs font-black text-emerald-600 mt-0.5">
                  ₹{inquiryModalItem.rateINR.toLocaleString("en-IN")} /{" "}
                  {inquiryModalItem.unit}
                </div>
              </div>
            </div>
            ...
            >
              <div>
                <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">
                  Quantity Required ({inquiryModalItem.unit})
                </label>
                <input
                  type="number"
                  min={1}
              ...
              <div className="p-3 bg-indigo-50 dark:bg-indigo-950/50 border border-indigo-200 dark:border-indigo-800/80 rounded-2xl space-y-1">
                <div className="flex items-center justify-between font-bold text-indigo-900 dark:text-indigo-200">
                  ...
                  <span className="text-sm font-black text-emerald-600 dark:text-emerald-400">
                    ₹
                    {(inquiryModalItem.rateINR * orderQuantity).toLocaleString(
                      "en-IN",
                    )}
                  </span>
                </div>
                <p className="text-[10px] text-slate-500 dark:text-slate-400">
                  Inquiry will be sent to empanelled vendors in your district.
                  You will receive competitive rate quotes via WhatsApp &amp;
                  In-app notification.
                </p>
              </div>
