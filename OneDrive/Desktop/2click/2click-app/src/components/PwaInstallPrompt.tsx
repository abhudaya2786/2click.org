        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 pr-6">
            ...
            <p className="text-xs text-slate-300 mt-0.5 leading-snug">
              Install web app to your home screen for instant offline BOQ
              calculators &amp; Dukandar market access.
            </p>
          </div>
        </div>
        ...
        {showIosGuide && isIos && (
          <div className="mt-3 p-3 bg-slate-950/80 rounded-xl border border-teal-500/30 text-xs text-slate-300 space-y-1.5 animate-in fade-in">
            <p className="font-bold text-white flex items-center gap-1">
              <Share2 className="w-3.5 h-3.5 text-teal-400" /> Safari iPhone
              Installation:
            </p>
            <ol className="list-decimal list-inside space-y-1 text-[11px]">
              <li>
                Tap the <span className="text-teal-300 font-bold">Share</span>{" "}
                icon in Safari toolbar
              </li>
              <li>
                Scroll down &amp; tap{" "}
              ...
              <li>
                Tap{" "}
                <span className="text-teal-300 font-bold">&quot;Add&quot;</span>{" "}
                to launch as native app
              </li>
            </ol>
          </div>
        )}
