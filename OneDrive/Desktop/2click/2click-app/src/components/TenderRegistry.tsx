...
const INITIAL_TENDERS: TenderItem[] = [
  {
    ...
    description:
      "RCC foundation works with heavy structural grade reinforcement as per IS 456 guidelines.",
  },
  {
    id: "#TN-2023-902",
    ...
    description:
      "PM Surya Ghar 5MW Solar Installation with Tier-1 bifacial panels & inverter stringing.",
  },
  {
    id: "#TN-2023-945",
    ...
    description:
      "Premium acoustic wall panelling, Italian marble flooring & automated ELV lighting.",
  },
  {
    id: "#TN-2023-958",
    ...
    description:
      "Comprehensive electrical distribution, transformer setup, STP piping & fire hydrants.",
  },
  {
    id: "#SOL-2024-SV",
    ...
    description:
      "Hybrid rooftop solar system with smart net metering, battery storage & remote monitoring.",
  },
];
...
export const TenderRegistry: React.FC<TenderRegistryProps> = ({
  ...
  const [tenders, setTenders] = useState<TenderItem[]>(() => {
    return getSafeLocalStorage<TenderItem[]>(
      "2click_tender_registry",
      INITIAL_TENDERS,
    );
  });
  ...
  const filteredTenders = tenders.filter((t) => {
    ...
    const matchesLocation =
      ...
      t.location.toLowerCase().includes(selectedLocation.toLowerCase());
    const matchesSearch =
      searchQuery === "" ||
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Centralized procurement management for solar, RCC construction,
            interior & infrastructure tenders.
          </p>
        </div>
                ...
                <tr>
                  ...
                  >
                    <p className="font-bold text-sm">
                      No tenders found matching selected filter criteria.
                    </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
          <div className="bg-slate-900 border border-pink-500/30 rounded-2xl max-w-xl w-full p-6 space-y-6 shadow-2xl relative overflow-hidden">
            <div className="flex justify-between items-center border-b border-slate-800 pb-4">
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Post tender requirements to local and national contractor
                  network
                </p>
              </div>
              <button
            ...
            <form onSubmit={handleCreateTender} className="space-y-4 text-xs">
              ...
              <div>
                <label className="block text-slate-300 font-bold mb-1">
                  Project Subtitle / Scope Summary
                </label>
                <input
                  type="text"
