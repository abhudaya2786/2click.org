...
export const UserProfileModal: React.FC<UserProfileModalProps> = ({
  ...
  const [activeSection, setActiveSection] = useState<
    "profile" | "security" | "role" | "sessions"
  >("profile");
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
                    Manage your public profile information, location, and
                    account details.
                  </p>
                </div>
            ...
            {activeSection === "security" && (
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
                    Manage passwords, connected auth providers, and multi-factor
                    security.
                  </p>
                </div>
                  ...
                  <div className="p-3.5 bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-200/80 dark:border-zinc-800 rounded-2xl flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-[11px] text-zinc-500 dark:text-zinc-400">
                          Verified Indian Construction &amp; Vendor KYC
                          Document.
                        </div>
                      </div>
                    </div>
            ...
            {activeSection === "role" && (
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
                    Your assigned platform role and fine-grained administrative
                    access.
                  </p>
                </div>
